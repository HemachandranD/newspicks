...
def create_agent_executor():
    try:
        ...
        Get the News Title and URL of the content and Your answer should contain News Title and the URL of the content in a format
        such that the title is in Bold large font and the URl is in italics with a hyperlink text as Read More."""
